...
type Props = {
  ...
  presets: TextInputPreset[];
  onApply: (preset: TextInputPreset) => void;
};
...
export default function PresetsSection({ state, presets, onApply }: Props) {
  ...
  return (
    <div className="space-y-6">
      <Section title="Presets" subtitle="Apply a complete input starting point, then keep editing from there.">
